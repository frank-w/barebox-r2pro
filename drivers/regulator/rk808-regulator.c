...
#define RK817_BOOST_DESC(_min, _max, _step, _vreg,\
...
#define RK8XX_DESC_COM(_min, _max, _step, _vreg,	\
...
#define RK805_DESC(_min, _max, _step, _vreg,	\
	_vmask, _ereg, _emask, _etime)					\
	RK8XX_DESC_COM(_min, _max, _step, _vreg,	\
	_vmask, _ereg, _emask, 0, 0, _etime, &rk808_reg_ops)

#define RK8XX_DESC(_min, _max, _step, _vreg,	\
	_vmask, _ereg, _emask, _etime)					\
	RK8XX_DESC_COM(_min, _max, _step, _vreg,	\
	_vmask, _ereg, _emask, 0, 0, _etime, &rk808_reg_ops)

#define RK817_DESC(_min, _max, _step, _vreg,	\
	_vmask, _ereg, _emask, _disval, _etime)				\
	RK8XX_DESC_COM(_min, _max, _step, _vreg,	\
	_vmask, _ereg, _emask, _emask, _disval, _etime, &rk817_reg_ops)

#define RKXX_DESC_SWITCH_COM(_ereg, _emask,	\
	_enval, _disval, _ops)						\
	{{								\
		.enable_reg	= (_ereg),				\
		.enable_mask	= (_emask),				\
...
#define RK817_DESC_SWITCH(_ereg, _emask,		\
	_disval)							\
	RKXX_DESC_SWITCH_COM(_ereg, _emask,	\
	_emask, _disval, &rk817_switch_ops)

#define RK8XX_DESC_SWITCH(_ereg, _emask)		\
	RKXX_DESC_SWITCH_COM(_ereg, _emask,	\
...
static struct rk_regulator_cfg rk809_reg[] = {
	...
	RK817_DESC(600, 3400, 25,
		   ...
		   DISABLE_VAL(0), 400),
	RK817_DESC_SWITCH(RK817_POWER_EN_REG(3), ENABLE_MASK(2),
			  DISABLE_VAL(2)),
	RK817_DESC_SWITCH(RK817_POWER_EN_REG(3), ENABLE_MASK(3),
			  DISABLE_VAL(3)),
};
...
static struct rk_regulator_cfg rk817_reg[] = {
	...
	RK817_DESC(600, 3400, 25,
		   ...
		   RK817_POWER_EN_REG(3), ENABLE_MASK(0),
		   DISABLE_VAL(0), 400),
	RK817_BOOST_DESC(4700, 5400, 100,
...
static struct rk_regulator_cfg rk818_reg[] = {
	...
	RK8XX_DESC_SWITCH(RK818_DCDC_EN_REG, BIT(6)),
	RK8XX_DESC_SWITCH(RK818_H5V_EN_REG, BIT(0)),
	RK8XX_DESC_SWITCH(RK818_DCDC_EN_REG, BIT(7)),
};
